...
public class VentanaAltaArticulo extends javax.swing.JFrame {
   ...
   private GestorBD g;
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                ...
                                .addComponent(cboRubro, 0, 125, Short.MAX_VALUE))
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
    ...
    private void cargarCombo() {
        ...
        g = new GestorBD();
        lista = g.obtenerRubros();
        for (Rubro rubro : lista) {
            cboRubro.addItem(rubro.toString());
        }
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        try {
            ...
            Rubro r = (Rubro)cboRubro.getSelectedItem();

            Articulo a = new Articulo(descripcion, precio, r);
